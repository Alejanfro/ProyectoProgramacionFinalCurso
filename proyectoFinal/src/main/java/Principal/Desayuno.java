...
public class Desayuno implements Comida {
    ...
    /*
    * @variable interna de clase primero tipo AltoNivelCalorico: primer alimento del desayuno
    * @variable interna de clase gramosPrimero tipo int: gramos del primer alimento del desayuno
    * @variable interna de clase segundo tipo AltoNivelCalorico: segundo alimento del desayuno
    * @variable interna de clase gramosSegundo tipo int: gramos del segundo alimento del desayuno
    * @variable interna de clase acompanante tipo int: tercer alimento del desayuno
    * @variable interna de clase gramosAcompanante tipo BajoNivelCalorico: gramos del tercer alimento del desayuno
    * @variable interna de clase kcalTotales tipo int: kcalorias totales del desayuno
     */
    ...
    /*
    * Constructor publico con 6 parametros y 2 excepciones del mismo tipo
    * @variable interna de clase primero tipo AltoNivelCalorico: primer alimento del desayuno
    * @variable interna de clase gramosPrimero tipo int: gramos del primer alimento del desayuno
    * @variable interna de clase segundo tipo AltoNivelCalorico: segundo alimento del desayuno
    * @variable interna de clase gramosSegundo tipo int: gramos del segundo alimento del desayuno
    ...
    * @return primero, que hace referencia al primer alimento del desayuno
     */
    ...
    * @param primero, variable tipo AltoNivelCalorico que hace referencia al primer alimento del desayuno
     */
    ...
    * @return gramosPrimero, variable tipo int que a los gramos del primer alimento del desayuno
     */
    ...
    * @param gramosPrimero, variable tipo int que hace referencia  a los gramos del primer alimento del desayuno
     */
    ...
    /*
    * Metodo getter, este metodo devuelve la variable interna (private AltoNivelCalorico segundo)
    * @return segundo, que hace referencia al segundo alimento del desayuno
     */
    ...
    /*
    * Metodo setter, este metodo sirve para modificar una variable interna (private AltoNivelCalorico segundo). 
    * Recibe por argumentos una variable de tipo AltoNivelCalorico que (mediante this.) se carga en la variable interna de clase 
    * @param segundo, variable tipo AltoNivelCalorico que hace referencia al segundo alimento del desayuno
     */
    ...
    * Recibe por argumentos una variable de tipo int que (mediante this.) se carga en la variable interna de clase 
    * @param gramosSegundo, variable tipo int que hace referencia  a los gramos del segundo alimento del desayuno
     */
    ...
    * @return acompanante, que hace referencia al tercer alimento del desayuno
     */
    ...
    * @param acompanante, variable tipo AltoNivelCalorico que hace referencia al tercer alimento del desayuno
     */
    ...
    /*
    * Metodo getter, este metodo devuelve la variable interna (private BajoNivelCalorico acompanante)
    * @return gramosAcompanante, que hace referencia al tercer alimento del desayuno
     */
    ...
    * Recibe por argumentos una variable de tipo int que (mediante this.) se carga en la variable interna de clase 
    * @param gramosAcompanante, variable tipo int que hace referencia  a los gramos del tercer alimento del desayuno
     */
    ...
    * @return kcalTotales, que hace referencia a las kcal totales del desayuno
    */
    ...
    * Recibe por argumentos una variable de tipo int que (mediante this.) se carga en la variable interna de clase 
    * @param kcalTotales, variable tipo int que hace referencia a las kcal totales del desayuno
     */
