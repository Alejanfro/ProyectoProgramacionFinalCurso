 ...
 * el limite en 150 kcal por 100 gramo. Se considera alimentos de bajo nivel
 * calorico, cuando tiene 150 o menos kcal * 100gramos.
...
public abstract class BajoNivelCalorico implements Alimento {
    ...
    * @throws Excepciones.BajoNivelCaloricoException en caso de que el alimento tenga más de 150kcal por 100 gramos
    */
    public BajoNivelCalorico(String nombre, int energia, int grasas, int proteinas, int carbohidratos, float sal, float azucar) throws BajoNivelCaloricoException, AlimentoException {
    ...
    /*
    * Metodo getter de la clase BajoNivelCalorico, 
    ...
    */
    ...
    /*
    * Metodo setter de la clase BajoNivelCalorico, 
    ...
    */
    ...
    /*
    * Metodo que concatena la informacion de la clase BajoNivelCalorico para mostrarlo por pantalla
