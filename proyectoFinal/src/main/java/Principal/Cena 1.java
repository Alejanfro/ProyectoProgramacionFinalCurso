 ...
 */
public class Cena implements Comida {

    /*
    * @variable interna de clase primero tipo BajoNivelCalorico: primer alimento de la cena
    * @variable interna de clase gramosPrimero tipo int: gramos del primer alimento de la cena
    * @variable interna de clase segundo tipo BajoNivelCalorico: segundo alimento de la cena
    * @variable interna de clase gramosSegundo tipo int: gramos del segundo alimento de la cena
    * @variable interna de clase acompanante tipo int: tercer alimento de la cena
    * @variable interna de clase gramosAcompanante tipo BajoNivelCalorico: gramos del tercer alimento de la cena
    * @variable interna de clase kcalTotales tipo int: kcalorias totales de la cena
     */
    private BajoNivelCalorico primero;
    ...
    * @variable interna de clase primero tipo AltoNivelCalorico: primer alimento de la cena
    * @variable interna de clase gramosPrimero tipo int: gramos del primer alimento de la cena
    * @variable interna de clase segundo tipo AltoNivelCalorico: segundo alimento de la cena
    * @variable interna de clase gramosSegundo tipo int: gramos del segundo alimento de la cena
    * @variable interna de clase acompanante tipo int: tercer alimento de la cena
    * @variable interna de clase gramosAcompanante tipo BajoNivelCalorico: gramos de la tercer alimento del cena
    * @variable interna de clase kcalTotales tipo int: kcalorias totales de la cena
    ...
    * @throws Excepciones.ComidaException en caso de dejar alguna comida vacía
    ...
    /*
    * Metodo getter, este metodo devuelve la variable interna (private BajoNivelCalorico primero)
    * @return primero, que hace referencia al primer alimento de la cena
     */
    ...
    /*
    * Metodo setter, este metodo sirve para modificar una variable interna (private BajoNivelCalorico primero). 
    * Recibe por argumentos una variable de tipo AltoNivelCalorico que (mediante this.) se carga en la variable interna de clase 
    * @param primero, variable tipo BajoNivelCalorico que hace referencia al primer alimento de la cena
     */
    public void setPrimero(BajoNivelCalorico primero) {
        this.primero = primero;
    }

    /*
    * Metodo getter, este metodo devuelve la variable interna (private int gramosPrimero)
    * @return gramosPrimero, variable tipo int que a los gramos del primer alimento de la cena
     */
    ...
    * @param segundo, variable tipo BajoNivelCalorico que hace referencia al segundo alimento de la cena
     */
    ...
    /*
    * Metodo getter, este metodo devuelve la variable interna (private BajoNivelCalorico segundo)
    * @return segundo, que hace referencia al segundo alimento de la cena
     */
    ...
    * Recibe por argumentos una variable de tipo int que (mediante this.) se carga en la variable interna de clase 
    * @param gramosSegundo, variable tipo int que hace referencia  a los gramos del segundo alimento de la cen
     */
    ...
    * @return acompanante, que hace referencia al tercer alimento de la cena
     */
    ...
    * Recibe por argumentos una variable de tipo BajoNivelCalorico que (mediante this.) se carga en la variable interna de clase 
    * @param acompanante, variable tipo AltoNivelCalorico que hace referencia al tercer alimento de la cena
     */
    ...
    /*
    * Metodo getter, este metodo devuelve la variable interna (private BajoNivelCalorico acompanante)
    * @return gramosAcompanante, que hace referencia al tercer alimento de la cena
     */
    ...
    * Recibe por argumentos una variable de tipo int que (mediante this.) se carga en la variable interna de clase 
    * @param gramosAcompanante, variable tipo int que hace referencia  a los gramos del tercer alimento de la cena
     */
    ...
    * @return kcalTotales, que hace referencia a las kcal totales de la cena
     */
    ...
    * Recibe por argumentos una variable de tipo int que (mediante this.) se carga en la variable interna de clase 
    * @param kcalTotales, variable tipo int que hace referencia a las kcal totales de la cena
     */
