...
public class Grupo4_VerduraHortalizas extends BajoNivelCalorico {
    ...
    * @throws Excepciones.AlimentoException en caso de que los valores nutricionales introducidos sean negativos
     */
    public Grupo4_VerduraHortalizas(String nombre, int energia, int grasas, int proteinas, int carbohidratos, float sal, float azucar, int fibra) throws BajoNivelCaloricoException, AlimentoException {
