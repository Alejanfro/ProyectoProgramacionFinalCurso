...
public class Grupo2Alto_CarnesPescadosHuevos extends AltoNivelCalorico {
    ...
    */
    public Grupo2Alto_CarnesPescadosHuevos(String nombre, int energia, int grasas, int proteinas, int carbohidratos, float sal, float azucar, int grasaSaturadas) throws AltoNivelCaloricoException, AlimentoException {
