...
public class Grupo5Bajo_Frutas extends BajoNivelCalorico {
    ...
    */
    public Grupo5Bajo_Frutas(String nombre, int energia, int grasas, int proteinas, int carbohidratos, float sal, float azucar, int fibra) throws BajoNivelCaloricoException, AlimentoException {
