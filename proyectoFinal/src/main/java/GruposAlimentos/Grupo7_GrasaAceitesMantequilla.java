...
public class Grupo7_GrasaAceitesMantequilla extends AltoNivelCalorico {
    private int grasaSaturadas;//Variable interna referente a la grasa saturada que contiene el alimento
    ...
    */
    public Grupo7_GrasaAceitesMantequilla(String nombre, int energia, int grasas,int proteinas,int carbohidratos, float sal, float azucar, int grasaSaturadas) throws AltoNivelCaloricoException, AlimentoException {
    ...
    * @return grasaSaturadas, variable tipo int que hace referencia a la grasa saturadas por cada 100 gramos que contiene el alimento 
    */
    ...
    * @param grasaSaturadas, variable tipo int que hace referencia a la grasa Saturadas por cada 100 gramos que contiene el alimento 
    */
