 ...
 */
public class Grupo3Bajo_PatatasLegunbresFrutosSecos extends BajoNivelCalorico {
    ...
    */
    public Grupo3Bajo_PatatasLegunbresFrutosSecos(String nombre, int energia, int grasas, int proteinas, int carbohidratos, float sal, float azucar, int fibra) throws BajoNivelCaloricoException, AlimentoException {
    ...
    */
    ...
    /*
    * Metodo getter, sobreescribe un metodo de la clase abstracta BajoNivelCalorico
    ...
    */
    ...
    public int calcularFibra(int cantidadGramos){
     ...
     /*
     * Metodo toString,sobreescribe un metodo de la clase abstracta BajoNivelCalorico que concatena la informacion 
