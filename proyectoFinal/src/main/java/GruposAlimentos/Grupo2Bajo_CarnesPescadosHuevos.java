...
public class Grupo2Bajo_CarnesPescadosHuevos extends BajoNivelCalorico {
    ...
    */
    public Grupo2Bajo_CarnesPescadosHuevos(String nombre, int energia, int grasas, int proteinas, int carbohidratos, float sal, float azucar, int grasaSaturadas) throws BajoNivelCaloricoException, AlimentoException {
