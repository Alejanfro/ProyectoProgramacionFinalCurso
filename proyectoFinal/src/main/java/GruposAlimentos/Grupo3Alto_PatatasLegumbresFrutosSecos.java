...
public class Grupo3Alto_PatatasLegumbresFrutosSecos extends AltoNivelCalorico {
    ...
    */
    public Grupo3Alto_PatatasLegumbresFrutosSecos(String nombre, int energia, int grasas, int proteinas, int carbohidratos, float sal, float azucar, int fibra) throws AltoNivelCaloricoException, AlimentoException {
