...
public class Grupo1Bajo_LecheDerivados extends BajoNivelCalorico {
    ...
    */
    public Grupo1Bajo_LecheDerivados(String nombre, int energia, int grasas, int proteinas, int carbohidratos, float sal, float azucar, int grasaSaturadas) throws BajoNivelCaloricoException, AlimentoException {
